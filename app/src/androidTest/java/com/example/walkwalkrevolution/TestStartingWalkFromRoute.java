...
public class TestStartingWalkFromRoute {
    ...
    @Test
    public void testStartingWalkFromRoute() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.walk_label), withText("Current/last walk"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Current/last walk")));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.route_steps_value), withText("500"),
                        childAtPosition(
                                childAtPosition(
