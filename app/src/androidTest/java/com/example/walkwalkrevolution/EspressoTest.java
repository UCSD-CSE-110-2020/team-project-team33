...
public class EspressoTest {
    ...
    public void espressoTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.overall_steps), withText("0"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.overall_dist), withText("0.0 mi"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.tableLayout),
                                        2),
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("0.0 mi")));
    }
